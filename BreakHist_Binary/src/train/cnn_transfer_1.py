...
def main():
    ...
    run_eval_and_artifacts(
        ...
        ds,
        args.threshold,
        npz_path=str(model_dir/"cnn6_resnet50_predictions.npz"),
        gradcam_dir=True,
        last_conv_layer_name="conv5_block3_out",  # capa conv final de ResNet50 para Grad-CAM
        save_path=str(model_dir/"cnn6_resnet50_transfer_final.h5"),
    )
